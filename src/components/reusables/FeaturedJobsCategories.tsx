...
export const FeaturedJobsCategories = ({
	...
	return (
		<button
			className={`flex flex-grow-0 flex-shrink-0 flex-basis-auto h-[36px] overflow-hidden px-[18px] selection:bg-inherit py-[10px] ${
				checked ? 'bg-purple-800' : 'bg-white'
			} md:border md:border-purple-300 rounded-[20px] md:rounded-[40px] justify-between items-center gap-[4px] `}
			onClick={() =>
				onChange({
