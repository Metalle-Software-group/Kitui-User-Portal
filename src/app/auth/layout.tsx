...
export default function DashboardLayout({ children }: TNodes) {
	return (
		<div className="w-full h-screen text-login-screen-text-color bg-login-screen-text-color text-black flex justify-center bg-[url('/images/others/login.svg')] bg-cover bg-no-repeat">
