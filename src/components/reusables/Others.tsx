...
export const DepartmentCard = ({ name, icon, activeJobs }: TMinistry) => {
	return (
		<div className='h-[84px] w-[280px] gap-[12px] rounded-[6px] p-[12px] border border-gray-border flex items-center justify-between bg-white'>
			<div className='flex-[1]'>
				{icon ? (
					<img
						src={`${BACKEND_BASE_URL}${icon.url}`}
...
export const CommentCard = ({
	...
	return (
		<div
			className='md:w-[379px] p-[20px] bg-white border mx-auto rounded-[20px] gap-[12px] border-boxBorder-color flex flex-col justify-between'
			{...{
				onClick: () => router.push(`/jobs/${id}`),
				title: 'Open this job',
			}}>
			<div className='w-full'>
				<div className='flex gap-[16px] justify-between flex-wrap flex-col'>
			...
			<div className='flex justify-between my-[6px] mt-auto'>
				<div
	...
	return (
		<div className='w-full'>
			...
			<div className='w-full'>
				...
				<div className='flex items-center justify-center my-[20px] mt-[30px]'>
					<MoreJobsComponent
						{...{
							onClickHandler: () => {
