...
export default function () {
	...
	return (
		<div className='py-[60px] px-[30px] flex flex-col gap-[20px]'>
			...
			<div className='flex flex-col items-center flex-wrap sm:grid sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 rounded-[6px] mt-[16px] h-[98%] text-black gap-[20px] justify-between'>
				{isMinistryLoading ? (
