			...
			<div className='absolute top-0 left-0 w-full overflow-hidden transform rotate-[180deg] z-[1] bg-footer-btnColor'>
				<svg
					...
					<path
						...
						className='fill-bodyBg'
					/>
				</svg>
			</div>

			<div className='text-bodyBg'>
				<div className='flex w-full h-fit justify-center bg-footer-btnColor px-5 md:px-0'>
					...
					<div className='flex flex-col mt-[100px] md:mt-0 w-full space-y-10 md:pt-[200px] md:px-[100px]'>
						<div className='w-full space-y-5 md:h-[500px] md:grid md:grid-cols-6 border-b-2 border-bodyBg text-white '>
							<div className=''>
								<img
						...
						<div className='flex flex-col md:flex-row w-full items-center space-y-5  md:space-y-0 md:justify-between '>
							...
							<p className='text-white'>
								{t('@ 2024 County Government Of Kitui')}.
							</p>
							<p className='text-white'>{t('All rights preserved')}.</p>
						</div>
					</div>
				</div>
			</div>
