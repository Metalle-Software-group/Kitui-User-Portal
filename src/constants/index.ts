...
export const BACKEND_BASE_URL = 'https://careersapi.kitui.go.ke';

export const FRONTEND_BASE_URL = 'https://careers.kitui.go.ke';
...
export const EMAIL_CONFIRMATION_TOKEN_KEY = 'confirmation';
